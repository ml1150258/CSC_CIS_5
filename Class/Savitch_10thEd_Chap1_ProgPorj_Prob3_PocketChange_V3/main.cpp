...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    unsigned char  nHlfDls,//Number of Half Dollars
                     nQtrs,//Number of Quarters
                    nDimes,//Number of Dimes
                     nNkls,//Number of Nickels
                    nPenys;//Number of Pennies
    unsigned short pktChng;//Total Pocket Change
    
    //Initial Variables
    cout<<"This program computes the change in your pocket"<<endl;
    cout<<"Input the number of Half Dollars, Quarters,"<<endl;
    cout<<"Nickles, Dimes, and Pennies"<<endl;
    cout<<"All inputs must be in range from 0-9"<<endl;
    cin>>nHlfDls>>nQtrs>>nDimes>>nNkls>>nPenys;
    
    //Map the Inputs to the Outputs
    pktChng = (nHlfDls-'0')*HLFDOLR
            + (nQtrs-48)*QUARTER
            + (nDimes-'0')*DIME
            + (nNkls-48)*NICKLE + nPenys-'0';
