...
void  view(int,float,const int [], const int [],const float [],const float[]);
...
void  view(int numCmpd,float intRate,const int nYear[],const int initD8[]
                    ,const float interst[],const float savings[]){
