...
//Function Prototypes
void model(float [],float [],int [],int [],float,int);
void view(const float [],const float [],const int [],const int [],float,int);
...
void view(const float balance[],const float intrst[],const int yrAray[],
  const int d8Aray[],float intRate,int numCmpd){
...
void model(float balance[],float intrst[],int yrAray[],
  int d8Aray[],float intRate,int numCmpd){
