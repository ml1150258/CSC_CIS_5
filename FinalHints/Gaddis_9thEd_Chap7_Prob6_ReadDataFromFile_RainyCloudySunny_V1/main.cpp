 ...
 * Created on February 8th, 2022, 10:50 AM
 * Purpose: Read a 2D array
 */
...
void rdFile1(fstream &,char [][DAYS],char);
void rdFile2(fstream &,char [][DAYS],char);
...
void rdFile2(fstream &fn,char weather[][DAYS],char months){
    int month,day;
    month=day=0;
    while(fn>>weather[month][day++]){
        if(day==DAYS){
            day=0;
            month++;
        }
...
void rdFile1(fstream &fn,char weather[][DAYS],char months){
