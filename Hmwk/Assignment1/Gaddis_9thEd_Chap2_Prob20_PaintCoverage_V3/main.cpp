...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    float fncLen,//Fence length in feet
          fncHgt,//Fence height in feet
          ptCanCv;//Gallon of Paint to Cover ft^2
    unsigned char nmPtCns;//Number of cans of paint required
    ...
    cout<<"Number of Cans of Paint required = "
            <<static_cast<int>(nmPtCns)<<endl;
