...
int main(int argv,char **argc){
	...
	payChck=0;     //Initilze Pay Check to 0
	hrsWrkd=rand()%21+30;//Range of Hours Worked [30-50]
	
	//Map the Inputs to Outputs - Process
	payChck=hrsWrkd*payRate;//Straight time for all hours
	//Add the extra above the over time hours
	//Example of Ternery Operator and Short Cut Operator
	        // Boolean Test    ? Just Overtime             : Nothing more to add
	payChck += hrsWrkd>ovrTime ? payRate*(hrsWrkd-ovrTime) : 0;
