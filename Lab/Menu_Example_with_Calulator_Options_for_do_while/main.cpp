...
int main(int argc, char** argv) {
    ...
    nOpshun='4';//In this case we have 3 options
    do{
        //Display user choice
        cout<<"Choose from the options displayed"<<endl;
        cout<<"1 -> Calculator with For-Loop"<<endl;
        cout<<"2 -> Calculator with DoWhile-Loop"<<endl;
        cout<<"3 -> Calculator with While-Loop"<<endl;
        cout<<"4 -> Grade with Ternary Operator"<<endl;
        cout<<"etc....."<<endl;
