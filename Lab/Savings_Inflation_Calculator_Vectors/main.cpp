...
//Function Prototypes
void initial(string &,fstream &,vector<float> &,float &);
void heading(fstream &,unsigned char &,const vector<float> &,float &);
void compute(vector<float> &,vector<float> &,vector<char> &,unsigned char,float);
void display(const vector<float> &,const vector<float> &,const vector<char> &,unsigned char,float);
...
int main(int argc, char** argv) {
    ...
    vector<float> p(SIZEP);//Principle/Price $'s
    float i,//Interest/Inflation rate in %
          s;//Savings/Cost in $'s
    vector<float> int_inf(SIZEP);//Interest/inflation per year
    vector<char> yrAry(SIZEP);//Hold the year values
...
void display(const vector<float> &p,const vector<float> &int_inf,
        const vector<char> &yrAry,unsigned char n,float i){
...
void compute(vector<float> &p,vector<float> &int_inf,vector<char> &yrAry,
...
void heading(fstream &in,unsigned char &n,const vector<float> &p,float &i){
    //The Process -> Map Inputs to Outputs
    //Output the Information and Instructions
...
void initial(string &ifname,fstream &in,vector<float> &p,float &i){
