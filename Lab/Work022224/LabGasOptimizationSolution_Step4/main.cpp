...
int main(int argc, char** argv) {
    ...
    float mpg,//Miles per gallon for your vehicle
      ...
      totCstA,//Total Cost needed for station A
         disB,//Distance to gas station B
       ppGalB,//Price per gallon in $'s station B
      gasReqB,//Gas required to get to station B
      totGasB,//Total Gas needed for station B
      totCstB;//Total Cost needed for station B
    ...
    //Process or Map solutions
    gasReqB=2*disB/mpg;//2* since roundtrip
    totGasB=gNdid+gasReqB;
    totCstB=totGasB*ppGalB;
    itotCst=(totCstB+HLFPNY)*100;//Add 1/2 Penny shift 2 places Left
    totCstB=itotCst/100.0;//Shift back 2 places right
    ...
    cout<<endl;
    cout<<disB<<" = Distance from home in miles"<<endl;
    cout<<"$"<<ppGalB<<" = Price per Gallon"<<endl;
    cout<<gasReqB<<" = Gas Reguired for station B"<<endl;
    cout<<totGasB<<" = Total Gas needed for station B"<<endl;
    cout<<"$"<<totCstB<<" = Total Cost"<<endl;
