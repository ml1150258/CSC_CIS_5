...
int main(int argv,char **argc){
	...
	//Declare Variables
	unsigned short nDllrs, //Number of Dollars
	              ...
	              totChng;//Total change in Pennies
	...
	totChng = nDllrs*DOLLAR +  nHfDlrs*HLFDLLR +
	          nQrtrs*QUARTER + nDimes*DIME + 
			  nNckls*NICKEL +  nPnys*PENNY;
